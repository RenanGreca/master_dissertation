...
The network density is a value which abstracts the volume and frequency of connections in a vehicular network.
It is calculated using the transmission range of the nodes, the amount of nodes, and the total area of the simulation.
...
\begin{tabular}{|p{1.5cm}||p{1.5cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|}
 ...
 \hline
 Cost & $O(|V| \times |O|)$ & $O(|V|+|O|)$ & n/a & n/a & n/a \\
 \hline
\end{tabular}
\end{table}
