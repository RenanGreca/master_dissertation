...
For reasons explained in \autoref{chapter:truman}, relatively short inter-contact times is important for TruMan's functionality.
...
\autoref{table:properties_truman} replicates the one from \autoref{section:properties} with the addition of TruMan, providing a full comparison between itself and the related work.
...
\caption{Simulation with $\rho$ = 10m and varying percentages of malicious nodes (1/2).}
...
\caption{Simulation with $\rho$ = 10m and varying percentages of malicious nodes (2/2).}
...
\caption{Simulation with information aging, with different maximum age values (1/2).}
...
\caption{Simulation with information aging, with different maximum age values (2/2).}
