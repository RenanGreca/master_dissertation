...
%conclude
\Cref{table:properties} shows how well each studied trust model satisfies the eight properties described in \Cref{section:properties}.
The numbers used in the table are the same ones from \Cref{section:properties}.
