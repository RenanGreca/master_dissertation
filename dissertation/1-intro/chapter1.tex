...
Today, certain vehicle manufacturers already include the on-board technology required to enable vehicular communications in the real world \citep{toyota2015}.
...
In the case of a collision or other event, nearby nodes can broadcast alerts, which other nodes pick up and forward \citep{li2007routing}, as illustrated by \Cref{fig:collision}.
...
Next, \Cref{chap:simulations} explains the tools used to validate TruMan's functionality and presents the results of the experiments that were performed.
Finally, \Cref{chap:conclusion} presents the final thoughts on the project and concludes this document.
