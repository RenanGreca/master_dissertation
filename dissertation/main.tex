...
\field{Ciência da Computação}		% default do PPGInf, não mudar
...
% inclui páginas que só aparecem na versão final (inclusão automática)
 \include{0-preambulo/catalografica}		% ficha catalográfica
...
\include{1-intro/chapter1}			% introdução
\include{2-complexnetworks/chapter2}		% fundamentação teórica
\include{3-vanets/chapter3}		% revisão bibliográfica (estado da arte)
%\include{4-socialvanets/chapter4}		% proposta
\include{4-project/chapter4}		% experimentação e validação
\include{5-simulations/chapter5}
\include{6-conclusao/chapter6}		% conclusão
