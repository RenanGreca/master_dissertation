...
\include{0-preambulo/resumoextendido}
%\part{Dissertation}
% inclusao de cada capítulo, alterar a gosto (do professor de Metodologia...)
\include{1-intro/chapter1}			% introdução
\include{2-complexnetworks/chapter2}		% redes complexas
\include{3-vanets/chapter3}		% redes veiculares
%\include{4-socialvanets/chapter4}		% 
\include{4-project/chapter4}		% truman
\include{5-simulations/chapter5}	% validação
